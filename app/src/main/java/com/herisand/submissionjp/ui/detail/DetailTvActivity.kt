...
class DetailTvActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (extras !=null) {
            ...
            val extrasTv = extras.getString(EXTRA_TV)

            if (extrasID!=null && extrasTv != null) {
                true.progressBar()
                true.contentView()

                viewModel.setDetailContent(extrasID, extrasTv)
                viewModel.getDetailContent().observe(this, { detailData ->
                    false.progressBar()
                    false.contentView()
                    populateDetailTVShow(detailData)
                })
            }
    ...
    private fun populateDetailTVShow(detailData: DetailData) {
    ...
    fun Boolean.contentView() {
        activityDetailTvBinding.content.visibility = if (this) View.VISIBLE else View.INVISIBLE
    }
